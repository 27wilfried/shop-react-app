  ...
  return (
    <div className='relative'>
      <img src={LightButton} alt=""
        ...
        className={`w-12 cursor-pointer drop-shadow-[1px_1px_1px_rgba(0,0,0,0.1) transition-all duration-100 absolute right-0 z-10 ${theme == "dark" ? "opacity-0" : "opacity-100"}`} />
